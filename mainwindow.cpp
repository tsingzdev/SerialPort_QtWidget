...
{
    setWindowIcon(QIcon(":/img/serialportlogo.png"));
    ui->hexRecv->setChecked(true);
    ui->hexSend->setChecked(true);
    ui->recvData_2->setHidden(true);
}
...
void MainWindow::printToFile(QByteArray data)
{
    QFile file;
    QString fileName = "C:/Users/";
    QString userName = QDir::home().dirName();
    fileName.append(userName).append("/Desktop/serialLog123.txt");
